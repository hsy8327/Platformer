...
class Game:
    def __init__(self):
        ...
        # 랭킹 관련 변수
        self.show_ranking = False  # 랭킹 화면 표시 여부
        self.clear_time = 0  # 클리어 시점의 점수 저장 변수
        self.home_button_rect = pygame.Rect(0, 0, 200, 50)  # 홈 버튼 사각형 초기화

        # 클리어 시점의 점수 저장 함수 추가
        self.clear_time = 0
        self.nickname = ""  # 닉네임 변수 추가
        self.timer_record = ""  # 저장할 타이머 기록
    ...
    def run(self):
        while self.running:
            ...
            if self.state == 'menu':
                ...
                self.ranking_events()  # 랭킹 이벤트 처리
                self.ranking_draw()  # 랭킹 화면 그리기
    ...
    def clear_draw(self):
        ...
        home_y = time_y + 100  # 저장하기 버튼 위쪽에 위치
        ...
        save_y = challenge_y + 50  # 도전하기 위쪽에 위치
